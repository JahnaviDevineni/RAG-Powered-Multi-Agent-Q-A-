...
===============================
This implementation creates a RAG-based knowledge assistant with tool selection capabilities.
It handles document ingestion, semantic retrieval, and intelligent response generation.
"""
...
class RAGTool(Tool):
    ...
    def can_handle(self, query: str) -> bool:
        """RAG can handle any query as a fallback."""
        return True
    ...
    def execute(self, query: str) -> str:
        ...
        prompt = f"""
        You are an intelligent assistant providing accurate information based on the given context.
        ...
        Provide a comprehensive and accurate answer based on the context provided. If the information isn't in the context, say "I don't have enough information to answer this question."
        """
